...
class DepsearchParser ( Parser ):
    ...
    RULE_tokenExpression = 2
    RULE_negatedToken = 3
    RULE_atomicToken = 4
    RULE_dependencyDescription = 5
    ...
    class SequenceTokenContext(TokenExpressionContext):

        def __init__(self, parser, ctx:ParserRuleContext): # actually a DepsearchParser.TokenExpressionContext
            super().__init__(parser)
            self.lhs = None # AtomicTokenContext
            self.rhs = None # AtomicTokenContext
            self.copyFrom(ctx)

        def atomicToken(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(DepsearchParser.AtomicTokenContext)
            else:
    ...
    class DistanceTokenContext(TokenExpressionContext):
    ...
    class DependenciesTokenContext(TokenExpressionContext):

        def __init__(self, parser, ctx:ParserRuleContext): # actually a DepsearchParser.TokenExpressionContext
            super().__init__(parser)
            self.src = None # NegatedTokenContext
            self.copyFrom(ctx)
    ...
    def tokenExpression(self, _p:int=0):
        ...
        _prevctx = localctx
        _startState = 4
        self.enterRecursionRule(localctx, 4, self.RULE_tokenExpression, _p)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 55
            ...
            if la_ == 1:
                ...
                self.state = 37
                localctx.lhs = self.atomicToken()
                self.state = 38
                self.match(DepsearchParser.T__4)
                self.state = 39
                localctx.rhs = self.atomicToken()
                pass
                ...
                _prevctx = localctx
                self.state = 48
                localctx.src = self.negatedToken()
                self.state = 50 
                self._errHandler.sync(self)
                _alt = 1
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 59
                        localctx.rhs = self.tokenExpression(7)
                        pass
                        ...
                        self.state = 62
                        localctx.rhs = self.tokenExpression(6)
                        pass
    ...
    class JustATokenContext(NegatedTokenContext):
    ...
    def negatedToken(self):
        ...
        self.enterRule(localctx, 6, self.RULE_negatedToken)
        try:
            self.state = 71
            self._errHandler.sync(self)
    ...
    class DependencyDescriptionContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent:ParserRuleContext=None, invokingState:int=-1):
            super().__init__(parent, invokingState)
            self.parser = parser
            self.dst = None # NegatedTokenContext
    ...
    def sempred(self, localctx:RuleContext, ruleIndex:int, predIndex:int):
        ...
        self._predicates[2] = self.tokenExpression_sempred
        self._predicates[6] = self.dependencyExpression_sempred
