...
The only file of interest in here is Depsearch.g4, the ANTLR4 lexer and parser specification for the depsearch.
If you updated the specification, re-generate the contents of this directory using the following command:

    antlr4 -Dlanguage=Python3 -no-listener Depsearch.g4
